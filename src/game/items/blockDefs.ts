...
export const RAW_BLOCKS: RawBlockDef[] = [
  ...
  { id: 27, key: 'cactus', name: 'Cactus', solid: true, opaque: false, transparent: false, renderType: 'cube', lightEmission: 0, hardness: 0.4, toolType: 'none', minToolTier: 'hand', drop: null, dropCount: [1, 1] },
  ...
  { id: 42, key: 'door_wood', name: 'Wooden Door', solid: true, opaque: false, transparent: false, renderType: 'cube', lightEmission: 0, hardness: 3, toolType: 'axe', minToolTier: 'hand', drop: null, dropCount: [1, 1] },
